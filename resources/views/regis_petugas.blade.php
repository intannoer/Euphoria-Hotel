...
<body>
    <div class="container">
        ...
        <h3 class="alert alert-dark text-center mt-3">DAFTAR PETUGAS</h3>
        <a class = "btn btn-success" href="/petugas/login_petugas"> Kembali</a>
        <br/>
        <br/>

        <form action="/petugas/add_petugas" method="post">
            {{ csrf_field() }}
