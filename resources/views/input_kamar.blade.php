...
<body>
    <div class="container">
        ...
        <h3 class="alert alert-dark text-center mt-3">TAMBAH DATA KAMAR</h3>
        <a class = "btn btn-success" href="/kamar/read_kamar"> Kembali</a>
        <br/>
        <br/>

        <form action="/kamar/insert_kamar" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Masukkan Nomor Kamar" name="no_kamar"><br>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="file" class="form-control" placeholder="" name="gambar" id="inputGambar"><br>
                    </div>
                </div>
            </div>
