    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <div class="navbar-nav">
            ...
            <a class="dropdown-item disabled" href="/booking">Booking Sekarang</a>
        </div>
      </div>
    </nav>
    ...
    <form action="/petugas/insert_petugas" method="post">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="Masukkan NIP Anda" name="nomor_identitas"><br/>
                </div>
                <div class="col-md-3">
                    <label for="">Nama Lengkap : </label>
                </div>
                <div class="col-md-9">
                    <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap Anda" name="nama_lengkap"><br>
                </div>
                <div class="col-md-3">
                    <label for="">Tanggal Booking: </label>
                </div>
                <div class="col-md-9">
                    <input type="date" class="form-control" name="tgl_booking"><br/>
                </div>
                <div class="col-md-3">
            ...
            <th>
                <div class="tulisan-login">
                    <center><h5 class="judul-tulisan-login">Login untuk bisa lakukan reservasi.<h5></center>
                    <center><a class = "btn btn-success" href="/pelanggan/login_pelanggan">LOGIN</a></center>
                </div>
            </th>
        </div>
    </form>
